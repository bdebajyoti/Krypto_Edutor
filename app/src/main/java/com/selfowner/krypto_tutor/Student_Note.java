...
public class Student_Note extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student__note);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Student_Note.this,Student_Dashboard.class));
                finish();
            }
        });
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChild(UID)){
                    ...
                    //Toast.makeText(Student_Notes.this, ""+TSID+""+STREAM+""+SEMESTER, Toast.LENGTH_SHORT).show();
    ...
    private void LISTVIEW(String TSID,String STREAM,String SEMESTER){
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference(""+TSID).child("NOTES_SECTION").child(""+SEMESTER).child(""+STREAM);
