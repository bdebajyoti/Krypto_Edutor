...
public class Student_Audio extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student__audio);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Student_Audio.this,Student_Dashboard.class));
                finish();
            }
        });
    ...
    private void LISTVIEW(String TSID,String STREAM,String SEMESTER){
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference(""+TSID).child("AUDIO_SECTION").child(""+SEMESTER).child(""+STREAM);
