...
public class Student_Video extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student__video);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Student_Video.this,Student_Dashboard.class));
                finish();
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                target.setDataAndType(Uri.parse(upload.getUrl()),"video/*");
    ...
    private void LISTVIEW(String TSID,String STREAM,String SEMESTER){
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference(""+TSID).child("VIDEO_SECTION").child(""+SEMESTER).child(""+STREAM);
